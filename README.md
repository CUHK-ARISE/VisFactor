...
- **Extensive Model Coverage**: 39 frontier MLLMs from GPT, Gemini, Claude, LLaMA, Qwen, and SEED families
- **Rigorous Assessment**: Based on well-established psychometric tests (FRCT)

## 📈 Leaderboard

![VisFactor Leaderboard](assets/leaderboard.png)
...
```bash
git clone https://anonymous.4open.science/r/VisFactor-NeurIPS-ED-2026.git
cd VisFactor
